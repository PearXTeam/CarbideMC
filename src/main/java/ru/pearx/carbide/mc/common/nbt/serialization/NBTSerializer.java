package ru.pearx.carbide.mc.common.nbt.serialization;

import net.minecraft.nbt.NBTTagCompound;
import ru.pearx.carbide.mc.common.nbt.serialization.conversion.NBTConverter;
...
public final class NBTSerializer
{
    ...
    {
        return (targets.length == 0 || OtherUtils.arrayContains(targets, target));
    }
