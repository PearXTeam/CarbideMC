...
{
    public static ResourceLocation ID = new ResourceLocation(CarbideMC.MODID, "loot");
    ...
    {
        public TextBox table = new TextBox(new ResourceLocation(CarbideMC.MODID, "textures/gui/textbox.png"));
