...
{
    public static final IForgeRegistry<Multiblock> REGISTRY = new RegistryBuilder<Multiblock>().setName(new ResourceLocation(CarbideMC.MODID, "multiblock")).setType(Multiblock.class).create();
