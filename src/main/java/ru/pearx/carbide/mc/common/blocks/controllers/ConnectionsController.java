package ru.pearx.carbide.mc.common.blocks.controllers;
...
public class ConnectionsController
{
    ...
    public static IBlockState getExtendedState(IBlockState state, IBlockAccess world, BlockPos pos, ICanConnect conn)
    {
        if(state instanceof IExtendedBlockState)
        {
            IExtendedBlockState ext = (IExtendedBlockState) state;
            for(Map.Entry<EnumFacing, IUnlistedProperty<Boolean>> entr : ConnectionsController.PROPS.entrySet())
            {
