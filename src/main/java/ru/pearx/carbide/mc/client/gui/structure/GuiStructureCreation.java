...
{
    public static final String SAVE_FILE_NAME = CarbideMC.MODID + "_structure_creation_gui_save.dat";
    ...
    public TextBox fromPos = new TextBox(new ResourceLocation(CarbideMC.MODID, "textures/gui/textbox.png"));
    ...
    public Button procsAdd = new Button(new ResourceLocation(CarbideMC.MODID, "textures/gui/button.png"), "+", () ->
    {
    ...
    public Button procsRemove = new Button(new ResourceLocation(CarbideMC.MODID, "textures/gui/button.png"), "-", () ->
    {
    ...
    public void init()
    {
        ...
        Path p = Minecraft.getMinecraft().mcDataDir.toPath().resolve(SAVE_FILE_NAME);
        ...
        {
            CarbideMC.getLog().error("An IOException occurred when loading the Structure Creation GUI cache!", e);
        }
    }
    ...
    public void close()
    {
        try(OutputStream str = Files.newOutputStream(Minecraft.getMinecraft().mcDataDir.toPath().resolve(SAVE_FILE_NAME)))
        {
        ...
        {
            CarbideMC.getLog().error("An IOException occurred when saving the Structure Creation GUI cache!", e);
        }
    }
}