package ru.pearx.carbide.mc.client.gui.controls.common;
...
public class ProgressBar extends Control
{
    ...
    public void render()
    {
        ...
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(CarbideMC.MODID, "textures/gui/progress_bar/" + (System.currentTimeMillis() / 50 % 4) + ".png"));
